...
function App() {
  ...
  return (
    <div className="bg-black">
      ...
      <section className="relative z-20 min-h-screen bg-neutral-900 flex flex-col items-center justify-center text-white p-20">
                     ...
                     <div key={product.id} className="group relative aspect-[4/5] bg-neutral-800 rounded-3xl overflow-hidden border border-white/5 hover:border-white/20 transition-all duration-500 cursor-pointer shadow-2xl">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent p-10 flex flex-col justify-end items-start">
                           ...
                           <div className="flex w-full items-center justify-between">
                              ...
                              <button className="px-6 py-2 bg-white text-black text-xs font-bold uppercase rounded-full hover:bg-neutral-200 transition-colors">
                                 Add to Cart
                              </button>
                           </div>
                        </div>
      ...
      <footer className="py-20 text-center text-neutral-600 text-sm border-t border-white/5">
